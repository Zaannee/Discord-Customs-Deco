...
export default function Modal(props) {
	return (
		...
		>
			<div
				className="relative flex flex-col gap-4 bg-base-lowest shadow-base-lower/60 shadow-sm p-4 border border-border-faint xs:rounded-xl w-screen xs:w-[420px] min-h-screen xs:min-h-[200px] overflow-hidden text-white modal-box"
				style={{
			...
			>
				...
				<div className="flex justify-end bg-base-lowest mt-4 h-[38px]">
					{props.secondaryText && (
						<button
							type="button"
